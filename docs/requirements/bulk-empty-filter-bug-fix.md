...
**Implementation**:
- `/apps/kailash-dataflow/src/dataflow/core/nodes.py` (lines 1905, 1937)
- `/apps/kailash-dataflow/src/dataflow/database/bulk.py` (bulk operation handlers)

**Testing**:
- `/apps/kailash-dataflow/tests/integration/test_bulk_delete_empty_filter_bug.py`
- `/apps/kailash-dataflow/tests/integration/bulk_operations/test_bulk_delete_node_integration.py`
- `/apps/kailash-dataflow/tests/integration/bulk_operations/test_bulk_update_node_integration.py`

**Documentation**:
- `/apps/kailash-dataflow/docs/user-guide.md`
- `/apps/kailash-dataflow/docs/common-mistakes.md`
- `/apps/kailash-dataflow/CHANGELOG.md`
