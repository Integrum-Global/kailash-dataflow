...
- **Main CLAUDE.md**: `/apps/kailash-dataflow/CLAUDE.md`
- **User Guide**: `/apps/kailash-dataflow/docs/USER_GUIDE.md`
- **Under the Hood**: `/apps/kailash-dataflow/docs/UNDER_THE_HOOD.md`

### Test Examples
- **Unit Tests**: `/apps/kailash-dataflow/tests/unit/`
- **Integration Tests**: `/apps/kailash-dataflow/tests/integration/`
- **E2E Tests**: `/apps/kailash-dataflow/tests/e2e/`
