...
class TestDataFlowEngineRelationshipIntegration:
    ...
    def test_engine_auto_detects_belongs_to_relationship(self, test_suite):
    ...
    def test_engine_auto_detects_has_many_relationship(self, test_suite):
    ...
    def test_engine_class_name_to_table_name_conversion(self, test_suite):
    ...
    def test_engine_foreign_key_to_relationship_name_conversion(self, test_suite):
    ...
    def test_engine_get_relationships_all_models(self, test_suite):
    ...
    def test_engine_model_registration_with_auto_detection(self, test_suite):
    ...
    def test_engine_schema_discovery_integration(self, test_suite):
    ...
    def test_engine_show_tables_functionality(self, test_suite):
    ...
    def test_engine_scaffold_with_relationships(self, test_suite):
    ...
    def test_engine_health_check_with_relationships(self, test_suite):
    ...
    def test_engine_cleanup_after_model_registration(self, test_suite):
